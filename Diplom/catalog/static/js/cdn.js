!(function (r, u) {
  ...
  (v.VERSION = "0.7.18"),
    (v.BROWSER = { NAME: s, MAJOR: "major", VERSION: n }),
    ...
    (v.ENGINE = { NAME: s, VERSION: n }),
    (v.OS = { NAME: s, VERSION: n }),
    r && (r.UAParser = v);
})("object" == typeof window ? window : this);
var oSpPOptions = {
  sAppUrl: "https://gabestore.ru",
  sAppUrlShow: "https://gabestore.ru",
  sOrigUrl: "https://gabestore.ru",
  sOrigFFUrl: "https://gabestore.ru",
  ...
  bAutoSubscribe: true,
  sAppKey: "7dea11c2c3fdea7adbcf350cd75fa08c",
  prompt_settings: "",
  prompt_title: "",
  prompt_text: "",
  prompt_description: "-",
  ...
  show_splogo: "0",
  spdomain_website:
    "https://sendpulse.com/ru/webpush-powered-by-sendpulse?sn=0J7QntCeIMKr0JPQtdC50LHRgdGC0L7RgMK7",
  styles_prefix: "sp",
  aPoweredbyLabel: {
  ...
  (Q = k.getDate() + "" + Q),
    ...
    (this.registerChrome = function () {
      navigator.serviceWorker
        .register("/" + V + "-push-worker-fb.js", { updateViaCache: "none" })
        .then(function (e) {
          e.installing
        ...
        oSpP.getDbValue("SPIDs", "SubscriptionId", function (e) {
          void 0 === e.target.result
            ? (oSpP.sendSubscribeDataToServer(t, "subscribe", void 0, o, i),
              oSpP.putValueToDb("SPIDs", { type: "SubscriptionId", value: t }))
      ...
      if (((o.os = t.getOS().name), void 0 !== Y && 0 == Y && (e = !1), e)) {
        ...
        if (document.getElementsByClassName(V + "-backdrop-info").length) {
          ...
          i.setAttribute("style", "display:none"),
            i.setAttribute(
              "class",
              V + "-webpush-label " + n + " " + p + " " + a + " " + c
            ),
            i.setAttribute("onclick", "this.remove();");
          var l = document.createElement("div");
          if (
            (l.setAttribute("class", V + "-inner-content"),
            (l.innerHTML += r),
            "chrome" === o.name.toLowerCase())
          ) {
    ...
    (this.closeCustomPrompt = function (e) {
      oSpP.sendPromptStat("prompt_closed"),
        ...
        e && oSpP.putValueToDb("SPIDs", { type: "PromptClosed", value: 1 });
    }),
    ...
    (this.getVisitsCount = function () {
      ...
      oSpP.getDbValue("SPIDs", "VisitsCount", function (e) {
        void 0 === e.target.result || ((t = e.target.result.value), (t += 1)),
          oSpP.putValueToDb("SPIDs", { type: "VisitsCount", value: t }),
